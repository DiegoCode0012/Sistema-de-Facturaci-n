...
public class FacturaXlsxView extends AbstractXlsxView {
	...
	protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
		...
		Factura factura= (Factura)model.get("factura"); //capturamos el objeto que se paso a la vista
		...
		theaderStyle.setBorderLeft(BorderStyle.MEDIUM); //borders 
		...
		tbodyStyle.setBorderLeft(BorderStyle.THIN); //borders 
		...
		Row filaUltima=sheet.createRow(rownum);
		cell=filaUltima.createCell(2);
		cell.setCellValue(mensajes.getMessage("text.factura.form.total"));
		cell.setCellStyle(tbodyStyle);
		
		cell=filaUltima.createCell(3);
